import { setorTrabalhoCadastro, setorTrabalhoFiltroSelect, setorTrabalhoFiltrosListagem } from "../types/setorTrabalho.d";
import { deleteRequest, getRequest, postRequest, putRequest } from "../utils/axiosRequest";

export const postSetorTrabalhos = async (setorTrabalhoCadastro: setorTrabalhoCadastro) => {
  return await postRequest(`/SetorTrabalho`, setorTrabalhoCadastro);
};

export const getListSetorTrabalho = async (filtros: setorTrabalhoFiltrosListagem) => {
  return await postRequest(`/SetorTrabalho/Listagem`, filtros);
};

export const getImpressaoSetorTrabalho = async (filtros: setorTrabalhoFiltrosListagem) => {
...
export const getSelectSetorTrabalho = async (pesquisa: setorTrabalhoFiltroSelect) => {
