import { areaArmazenagemCadastro, areaArmazenagemFiltroSelect, areaArmazenagemFiltrosListagem } from "../types/areaArmazenagem.d";
import { deleteRequest, getRequest, postRequest, putRequest } from "../utils/axiosRequest";

export const postAreaArmazenagems = async (areaArmazenagemCadastro: areaArmazenagemCadastro) => {
  return await postRequest(`/AreaArmazenagem`, areaArmazenagemCadastro);
};

export const getListAreaArmazenagem = async (filtros: areaArmazenagemFiltrosListagem) => {
  return await postRequest(`/AreaArmazenagem/Listagem`, filtros);
};

export const getImpressaoAreaArmazenagem = async (filtros: areaArmazenagemFiltrosListagem) => {
